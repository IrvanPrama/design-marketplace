...
<div class="container my-5">
    ...
    <section class="mt-5">
        <div class="row mb-3">
            ...
            <a href="/dashboard/designer/done" class="btn" style="height:40px; width:100px;">
        ...
        <div class="card-order modal-content"
            ...
            <div class="row mt-0">
                ...
                <span class="ml-auto mr-2">
                    <div type="button" class="close text-center"
                        style="opacity: 1; border-radius: 100%; margin-top:-10px; background-color: red; color:white; width: 30px; height:30px;"
