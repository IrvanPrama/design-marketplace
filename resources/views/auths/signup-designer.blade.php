...
@section('name', 'Designer Signup | Akudesain')
@section('content')
                ...
                <div class="card-body bg-oten">
                    ...
                    <form action="/signup/account" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            is-invalid
                            @enderror" id="name" placeholder="Nama Lengkap" max="20">
                            @error('deadline')
                        ...
                        <div class="form-group">
                            <input type="tel" id="now_hp" value="{{ old('no_hp') }}" name="no_hp" class="form-control @error('no_hp')
                            is-invalid
